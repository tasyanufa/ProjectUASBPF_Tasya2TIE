                ...
                <div class="card-body">
                  ...
                  <input type="hidden" name="id" value="<?= $kategori['id']; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="keterangan" rows="5" name="keterangan" value="<?= $kategori['keterangan']; ?>" placeholder="Keterangan">
                    ...
                    <button type="submit" class="btn btn-primary mr-2" name="edit">Edit Kategori</button>
